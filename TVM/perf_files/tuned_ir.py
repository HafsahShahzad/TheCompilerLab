...
class Module:
    ...
    @T.prim_func(private=True)
    def fused_conv2d13_add2(lv162: T.Buffer((T.int64(1), T.int64(256), T.int64(14), T.int64(14)), "float32"), param_0: T.Buffer((T.int64(1024), T.int64(256), T.int64(1), T.int64(1)), "float32"), lv164: T.Buffer((T.int64(1), T.int64(1024), T.int64(14), T.int64(14)), "float32"), T_add_intermediate: T.Buffer((T.int64(1), T.int64(1024), T.int64(14), T.int64(14)), "float32")):
        T.func_attr({"tir.noalias": True})
        # with T.block("root"):
        pad_temp = T.alloc_buffer((T.int64(1), T.int64(256), T.int64(14), T.int64(14)))
        conv2d_nchw_intermediate = T.alloc_buffer((T.int64(1), T.int64(1024), T.int64(14), T.int64(14)))
        ...
        for nn, ff, yy, xx, rc, ry, rx in T.grid(T.int64(1), T.int64(1024), T.int64(14), T.int64(14), T.int64(256), T.int64(1), T.int64(1)):
            with T.block("conv2d_nchw"):
                v_nn, v_ff, v_yy, v_xx, v_rc, v_ry, v_rx = T.axis.remap("SSSSRRR", [nn, ff, yy, xx, rc, ry, rx])
                T.reads(pad_temp[v_nn, v_rc, v_yy + v_ry, v_xx + v_rx], param_0[v_ff, v_rc, v_ry, v_rx])
                T.writes(conv2d_nchw_intermediate[v_nn, v_ff, v_yy, v_xx])
                with T.init():
                    conv2d_nchw_intermediate[v_nn, v_ff, v_yy, v_xx] = T.float32(0.0)
                conv2d_nchw_intermediate[v_nn, v_ff, v_yy, v_xx] = conv2d_nchw_intermediate[v_nn, v_ff, v_yy, v_xx] + pad_temp[v_nn, v_rc, v_yy + v_ry, v_xx + v_rx] * param_0[v_ff, v_rc, v_ry, v_rx]
        for ax0, ax1, ax2, ax3 in T.grid(T.int64(1), T.int64(1024), T.int64(14), T.int64(14)):
            with T.block("T_add"):
                v_ax0, v_ax1, v_ax2, v_ax3 = T.axis.remap("SSSS", [ax0, ax1, ax2, ax3])
                T.reads(conv2d_nchw_intermediate[v_ax0, v_ax1, v_ax2, v_ax3], lv164[v_ax0, v_ax1, v_ax2, v_ax3])
                T.writes(T_add_intermediate[v_ax0, v_ax1, v_ax2, v_ax3])
                T_add_intermediate[v_ax0, v_ax1, v_ax2, v_ax3] = conv2d_nchw_intermediate[v_ax0, v_ax1, v_ax2, v_ax3] + lv164[v_ax0, v_ax1, v_ax2, v_ax3]

    @T.prim_func(private=True)
    def fused_conv2d19_add3(lv277: T.Buffer((T.int64(1), T.int64(512), T.int64(7), T.int64(7)), "float32"), param_0: T.Buffer((T.int64(2048), T.int64(512), T.int64(1), T.int64(1)), "float32"), lv279: T.Buffer((T.int64(1), T.int64(2048), T.int64(7), T.int64(7)), "float32"), T_add_intermediate: T.Buffer((T.int64(1), T.int64(2048), T.int64(7), T.int64(7)), "float32")):
        T.func_attr({"tir.noalias": True})
        # with T.block("root"):
        pad_temp = T.alloc_buffer((T.int64(1), T.int64(512), T.int64(7), T.int64(7)))
        conv2d_nchw_intermediate = T.alloc_buffer((T.int64(1), T.int64(2048), T.int64(7), T.int64(7)))
        ...
        for ax0, ax1, ax2, ax3 in T.grid(T.int64(1), T.int64(2048), T.int64(7), T.int64(7)):
            with T.block("T_add"):
                v_ax0, v_ax1, v_ax2, v_ax3 = T.axis.remap("SSSS", [ax0, ax1, ax2, ax3])
                T.reads(conv2d_nchw_intermediate[v_ax0, v_ax1, v_ax2, v_ax3], lv279[v_ax0, v_ax1, v_ax2, v_ax3])
                T.writes(T_add_intermediate[v_ax0, v_ax1, v_ax2, v_ax3])
                T_add_intermediate[v_ax0, v_ax1, v_ax2, v_ax3] = conv2d_nchw_intermediate[v_ax0, v_ax1, v_ax2, v_ax3] + lv279[v_ax0, v_ax1, v_ax2, v_ax3]

    @T.prim_func(private=True)
    def fused_conv2d3_add(lv27: T.Buffer((T.int64(1), T.int64(64), T.int64(56), T.int64(56)), "float32"), param_0: T.Buffer((T.int64(256), T.int64(64), T.int64(1), T.int64(1)), "float32"), lv29: T.Buffer((T.int64(1), T.int64(256), T.int64(56), T.int64(56)), "float32"), T_add_intermediate: T.Buffer((T.int64(1), T.int64(256), T.int64(56), T.int64(56)), "float32")):
        T.func_attr({"tir.noalias": True})
        # with T.block("root"):
        pad_temp = T.alloc_buffer((T.int64(1), T.int64(64), T.int64(56), T.int64(56)))
        conv2d_nchw_intermediate = T.alloc_buffer((T.int64(1), T.int64(256), T.int64(56), T.int64(56)))
        for i0, i1, i2, i3 in T.grid(T.int64(1), T.int64(64), T.int64(56), T.int64(56)):
            with T.block("pad_temp"):
                v_i0, v_i1, v_i2, v_i3 = T.axis.remap("SSSS", [i0, i1, i2, i3])
                T.reads(lv27[v_i0, v_i1, v_i2, v_i3])
        ...
        for ax0, ax1, ax2, ax3 in T.grid(T.int64(1), T.int64(256), T.int64(56), T.int64(56)):
            with T.block("T_add"):
                v_ax0, v_ax1, v_ax2, v_ax3 = T.axis.remap("SSSS", [ax0, ax1, ax2, ax3])
                T.reads(conv2d_nchw_intermediate[v_ax0, v_ax1, v_ax2, v_ax3], lv29[v_ax0, v_ax1, v_ax2, v_ax3])
                T.writes(T_add_intermediate[v_ax0, v_ax1, v_ax2, v_ax3])
                T_add_intermediate[v_ax0, v_ax1, v_ax2, v_ax3] = conv2d_nchw_intermediate[v_ax0, v_ax1, v_ax2, v_ax3] + lv29[v_ax0, v_ax1, v_ax2, v_ax3]

    @T.prim_func(private=True)
    def fused_conv2d7_add1(lv85: T.Buffer((T.int64(1), T.int64(128), T.int64(28), T.int64(28)), "float32"), param_0: T.Buffer((T.int64(512), T.int64(128), T.int64(1), T.int64(1)), "float32"), lv87: T.Buffer((T.int64(1), T.int64(512), T.int64(28), T.int64(28)), "float32"), T_add_intermediate: T.Buffer((T.int64(1), T.int64(512), T.int64(28), T.int64(28)), "float32")):
        T.func_attr({"tir.noalias": True})
        # with T.block("root"):
        pad_temp = T.alloc_buffer((T.int64(1), T.int64(128), T.int64(28), T.int64(28)))
        conv2d_nchw_intermediate = T.alloc_buffer((T.int64(1), T.int64(512), T.int64(28), T.int64(28)))
        ...
        for ax0, ax1, ax2, ax3 in T.grid(T.int64(1), T.int64(512), T.int64(28), T.int64(28)):
            with T.block("T_add"):
                v_ax0, v_ax1, v_ax2, v_ax3 = T.axis.remap("SSSS", [ax0, ax1, ax2, ax3])
                T.reads(conv2d_nchw_intermediate[v_ax0, v_ax1, v_ax2, v_ax3], lv87[v_ax0, v_ax1, v_ax2, v_ax3])
                T.writes(T_add_intermediate[v_ax0, v_ax1, v_ax2, v_ax3])
                T_add_intermediate[v_ax0, v_ax1, v_ax2, v_ax3] = conv2d_nchw_intermediate[v_ax0, v_ax1, v_ax2, v_ax3] + lv87[v_ax0, v_ax1, v_ax2, v_ax3]

    @T.prim_func(private=True)
    def fused_matmul_add4(lv325: T.Buffer((T.int64(1), T.int64(2048)), "float32"), param_0: T.Buffer((T.int64(2048), T.int64(1000)), "float32"), param_1: T.Buffer((T.int64(1000),), "float32"), T_add_intermediate: T.Buffer((T.int64(1), T.int64(1000)), "float32")):
        T.func_attr({"tir.noalias": True})
        # with T.block("root"):
        ...
        for i0, i1, k in T.grid(T.int64(1), T.int64(1000), T.int64(2048)):
            with T.block("matmul"):
                ...
                T.reads(lv325[v_i0, v_k], param_0[v_k, v_i1])
                T.writes(matmul_intermediate[v_i0, v_i1])
                with T.init():
                    matmul_intermediate[v_i0, v_i1] = T.float32(0.0)
                matmul_intermediate[v_i0, v_i1] = matmul_intermediate[v_i0, v_i1] + lv325[v_i0, v_k] * param_0[v_k, v_i1]
    ...
    @T.prim_func(private=True)
    def fused_relu(lv5_0: T.Buffer((T.int64(1), T.int64(64), T.int64(112), T.int64(112)), "float32"), compute_intermediate: T.Buffer((T.int64(1), T.int64(64), T.int64(112), T.int64(112)), "float32")):
        T.func_attr({"tir.noalias": True})
        # with T.block("root"):
        for i0, i1, i2, i3 in T.grid(T.int64(1), T.int64(64), T.int64(112), T.int64(112)):
            with T.block("compute"):
                v_i0, v_i1, v_i2, v_i3 = T.axis.remap("SSSS", [i0, i1, i2, i3])
                T.reads(lv5_0[v_i0, v_i1, v_i2, v_i3])
                T.writes(compute_intermediate[v_i0, v_i1, v_i2, v_i3])
                compute_intermediate[v_i0, v_i1, v_i2, v_i3] = T.max(lv5_0[v_i0, v_i1, v_i2, v_i3], T.float32(0.0))

    @T.prim_func(private=True)
    def fused_relu1(lv11_0: T.Buffer((T.int64(1), T.int64(64), T.int64(56), T.int64(56)), "float32"), compute_intermediate: T.Buffer((T.int64(1), T.int64(64), T.int64(56), T.int64(56)), "float32")):
        T.func_attr({"tir.noalias": True})
        # with T.block("root"):
        for i0, i1, i2, i3 in T.grid(T.int64(1), T.int64(64), T.int64(56), T.int64(56)):
            with T.block("compute"):
                v_i0, v_i1, v_i2, v_i3 = T.axis.remap("SSSS", [i0, i1, i2, i3])
                T.reads(lv11_0[v_i0, v_i1, v_i2, v_i3])
                T.writes(compute_intermediate[v_i0, v_i1, v_i2, v_i3])
                compute_intermediate[v_i0, v_i1, v_i2, v_i3] = T.max(lv11_0[v_i0, v_i1, v_i2, v_i3], T.float32(0.0))

    @T.prim_func(private=True)
    def fused_relu10(lv273_0: T.Buffer((T.int64(1), T.int64(512), T.int64(7), T.int64(7)), "float32"), compute_intermediate: T.Buffer((T.int64(1), T.int64(512), T.int64(7), T.int64(7)), "float32")):
        T.func_attr({"tir.noalias": True})
        # with T.block("root"):
        for i0, i1, i2, i3 in T.grid(T.int64(1), T.int64(512), T.int64(7), T.int64(7)):
            with T.block("compute"):
                v_i0, v_i1, v_i2, v_i3 = T.axis.remap("SSSS", [i0, i1, i2, i3])
                T.reads(lv273_0[v_i0, v_i1, v_i2, v_i3])
                T.writes(compute_intermediate[v_i0, v_i1, v_i2, v_i3])
                compute_intermediate[v_i0, v_i1, v_i2, v_i3] = T.max(lv273_0[v_i0, v_i1, v_i2, v_i3], T.float32(0.0))

    @T.prim_func(private=True)
    def fused_relu11(lv281_0: T.Buffer((T.int64(1), T.int64(2048), T.int64(7), T.int64(7)), "float32"), compute_intermediate: T.Buffer((T.int64(1), T.int64(2048), T.int64(7), T.int64(7)), "float32")):
        T.func_attr({"tir.noalias": True})
        # with T.block("root"):
        for i0, i1, i2, i3 in T.grid(T.int64(1), T.int64(2048), T.int64(7), T.int64(7)):
            with T.block("compute"):
                v_i0, v_i1, v_i2, v_i3 = T.axis.remap("SSSS", [i0, i1, i2, i3])
                T.reads(lv281_0[v_i0, v_i1, v_i2, v_i3])
                T.writes(compute_intermediate[v_i0, v_i1, v_i2, v_i3])
                compute_intermediate[v_i0, v_i1, v_i2, v_i3] = T.max(lv281_0[v_i0, v_i1, v_i2, v_i3], T.float32(0.0))

    @T.prim_func(private=True)
    def fused_relu2(lv31_0: T.Buffer((T.int64(1), T.int64(256), T.int64(56), T.int64(56)), "float32"), compute_intermediate: T.Buffer((T.int64(1), T.int64(256), T.int64(56), T.int64(56)), "float32")):
        T.func_attr({"tir.noalias": True})
        # with T.block("root"):
        for i0, i1, i2, i3 in T.grid(T.int64(1), T.int64(256), T.int64(56), T.int64(56)):
            with T.block("compute"):
                v_i0, v_i1, v_i2, v_i3 = T.axis.remap("SSSS", [i0, i1, i2, i3])
                T.reads(lv31_0[v_i0, v_i1, v_i2, v_i3])
                T.writes(compute_intermediate[v_i0, v_i1, v_i2, v_i3])
                compute_intermediate[v_i0, v_i1, v_i2, v_i3] = T.max(lv31_0[v_i0, v_i1, v_i2, v_i3], T.float32(0.0))

    @T.prim_func(private=True)
    def fused_relu3(lv75_0: T.Buffer((T.int64(1), T.int64(128), T.int64(56), T.int64(56)), "float32"), compute_intermediate: T.Buffer((T.int64(1), T.int64(128), T.int64(56), T.int64(56)), "float32")):
        T.func_attr({"tir.noalias": True})
        # with T.block("root"):
        for i0, i1, i2, i3 in T.grid(T.int64(1), T.int64(128), T.int64(56), T.int64(56)):
            with T.block("compute"):
                v_i0, v_i1, v_i2, v_i3 = T.axis.remap("SSSS", [i0, i1, i2, i3])
                T.reads(lv75_0[v_i0, v_i1, v_i2, v_i3])
                T.writes(compute_intermediate[v_i0, v_i1, v_i2, v_i3])
                compute_intermediate[v_i0, v_i1, v_i2, v_i3] = T.max(lv75_0[v_i0, v_i1, v_i2, v_i3], T.float32(0.0))

    @T.prim_func(private=True)
    def fused_relu4(lv81_0: T.Buffer((T.int64(1), T.int64(128), T.int64(28), T.int64(28)), "float32"), compute_intermediate: T.Buffer((T.int64(1), T.int64(128), T.int64(28), T.int64(28)), "float32")):
        T.func_attr({"tir.noalias": True})
        # with T.block("root"):
        for i0, i1, i2, i3 in T.grid(T.int64(1), T.int64(128), T.int64(28), T.int64(28)):
            with T.block("compute"):
                v_i0, v_i1, v_i2, v_i3 = T.axis.remap("SSSS", [i0, i1, i2, i3])
                T.reads(lv81_0[v_i0, v_i1, v_i2, v_i3])
                T.writes(compute_intermediate[v_i0, v_i1, v_i2, v_i3])
                compute_intermediate[v_i0, v_i1, v_i2, v_i3] = T.max(lv81_0[v_i0, v_i1, v_i2, v_i3], T.float32(0.0))

    @T.prim_func(private=True)
    def fused_relu5(lv89_0: T.Buffer((T.int64(1), T.int64(512), T.int64(28), T.int64(28)), "float32"), compute_intermediate: T.Buffer((T.int64(1), T.int64(512), T.int64(28), T.int64(28)), "float32")):
        T.func_attr({"tir.noalias": True})
        # with T.block("root"):
        for i0, i1, i2, i3 in T.grid(T.int64(1), T.int64(512), T.int64(28), T.int64(28)):
            with T.block("compute"):
                v_i0, v_i1, v_i2, v_i3 = T.axis.remap("SSSS", [i0, i1, i2, i3])
                T.reads(lv89_0[v_i0, v_i1, v_i2, v_i3])
                T.writes(compute_intermediate[v_i0, v_i1, v_i2, v_i3])
                compute_intermediate[v_i0, v_i1, v_i2, v_i3] = T.max(lv89_0[v_i0, v_i1, v_i2, v_i3], T.float32(0.0))

    @T.prim_func(private=True)
    def fused_relu6(lv152_0: T.Buffer((T.int64(1), T.int64(256), T.int64(28), T.int64(28)), "float32"), compute_intermediate: T.Buffer((T.int64(1), T.int64(256), T.int64(28), T.int64(28)), "float32")):
        T.func_attr({"tir.noalias": True})
        # with T.block("root"):
        for i0, i1, i2, i3 in T.grid(T.int64(1), T.int64(256), T.int64(28), T.int64(28)):
            with T.block("compute"):
                v_i0, v_i1, v_i2, v_i3 = T.axis.remap("SSSS", [i0, i1, i2, i3])
                T.reads(lv152_0[v_i0, v_i1, v_i2, v_i3])
                T.writes(compute_intermediate[v_i0, v_i1, v_i2, v_i3])
                compute_intermediate[v_i0, v_i1, v_i2, v_i3] = T.max(lv152_0[v_i0, v_i1, v_i2, v_i3], T.float32(0.0))

    @T.prim_func(private=True)
    def fused_relu7(lv158_0: T.Buffer((T.int64(1), T.int64(256), T.int64(14), T.int64(14)), "float32"), compute_intermediate: T.Buffer((T.int64(1), T.int64(256), T.int64(14), T.int64(14)), "float32")):
        T.func_attr({"tir.noalias": True})
        # with T.block("root"):
        for i0, i1, i2, i3 in T.grid(T.int64(1), T.int64(256), T.int64(14), T.int64(14)):
            with T.block("compute"):
                v_i0, v_i1, v_i2, v_i3 = T.axis.remap("SSSS", [i0, i1, i2, i3])
                T.reads(lv158_0[v_i0, v_i1, v_i2, v_i3])
                T.writes(compute_intermediate[v_i0, v_i1, v_i2, v_i3])
                compute_intermediate[v_i0, v_i1, v_i2, v_i3] = T.max(lv158_0[v_i0, v_i1, v_i2, v_i3], T.float32(0.0))

    @T.prim_func(private=True)
    def fused_relu8(lv166_0: T.Buffer((T.int64(1), T.int64(1024), T.int64(14), T.int64(14)), "float32"), compute_intermediate: T.Buffer((T.int64(1), T.int64(1024), T.int64(14), T.int64(14)), "float32")):
        T.func_attr({"tir.noalias": True})
        # with T.block("root"):
        for i0, i1, i2, i3 in T.grid(T.int64(1), T.int64(1024), T.int64(14), T.int64(14)):
            with T.block("compute"):
                v_i0, v_i1, v_i2, v_i3 = T.axis.remap("SSSS", [i0, i1, i2, i3])
                T.reads(lv166_0[v_i0, v_i1, v_i2, v_i3])
                T.writes(compute_intermediate[v_i0, v_i1, v_i2, v_i3])
                compute_intermediate[v_i0, v_i1, v_i2, v_i3] = T.max(lv166_0[v_i0, v_i1, v_i2, v_i3], T.float32(0.0))

    @T.prim_func(private=True)
    def fused_relu9(lv267_0: T.Buffer((T.int64(1), T.int64(512), T.int64(14), T.int64(14)), "float32"), compute_intermediate: T.Buffer((T.int64(1), T.int64(512), T.int64(14), T.int64(14)), "float32")):
        T.func_attr({"tir.noalias": True})
        # with T.block("root"):
        for i0, i1, i2, i3 in T.grid(T.int64(1), T.int64(512), T.int64(14), T.int64(14)):
            with T.block("compute"):
                v_i0, v_i1, v_i2, v_i3 = T.axis.remap("SSSS", [i0, i1, i2, i3])
                T.reads(lv267_0[v_i0, v_i1, v_i2, v_i3])
                T.writes(compute_intermediate[v_i0, v_i1, v_i2, v_i3])
                compute_intermediate[v_i0, v_i1, v_i2, v_i3] = T.max(lv267_0[v_i0, v_i1, v_i2, v_i3], T.float32(0.0))
    ...
    def main(data: R.Tensor((1, 3, 224, 224), dtype="float32")) -> R.Tensor((1, 1000), dtype="float32"):
        ...
        with R.dataflow():
            ...
            lv_1: R.Tensor((1, 64, 112, 112), dtype="float32") = lv5[0]
            lv1_1 = R.call_tir(cls.fused_relu, (lv_1,), out_sinfo=R.Tensor((1, 64, 112, 112), dtype="float32"))
            lv10 = R.call_tir(cls.max_pool2d, (lv1_1,), out_sinfo=R.Tensor((1, 64, 56, 56), dtype="float32"))
            ...
            lv2: R.Tensor((1, 64, 56, 56), dtype="float32") = lv11[0]
            lv3 = R.call_tir(cls.fused_relu1, (lv2,), out_sinfo=R.Tensor((1, 64, 56, 56), dtype="float32"))
            lv16 = R.call_tir(cls.conv2d1, (lv3, metadata["relax.expr.Constant"][13]), out_sinfo=R.Tensor((1, 64, 56, 56), dtype="float32"))
            ...
            lv4_1: R.Tensor((1, 64, 56, 56), dtype="float32") = lv17[0]
            lv5_1 = R.call_tir(cls.fused_relu1, (lv4_1,), out_sinfo=R.Tensor((1, 64, 56, 56), dtype="float32"))
            lv22 = R.call_tir(cls.conv2d2, (lv5_1, metadata["relax.expr.Constant"][18]), out_sinfo=R.Tensor((1, 64, 56, 56), dtype="float32"))
            ...
            lv6: R.Tensor((1, 64, 56, 56), dtype="float32") = lv23[0]
            lv7 = R.call_tir(cls.fused_relu1, (lv6,), out_sinfo=R.Tensor((1, 64, 56, 56), dtype="float32"))
            lv29 = R.call_tir(cls.conv2d3, (lv3, metadata["relax.expr.Constant"][23]), out_sinfo=R.Tensor((1, 256, 56, 56), dtype="float32"))
            lv8 = R.call_tir(cls.fused_conv2d3_add, (lv7, metadata["relax.expr.Constant"][24], lv29), out_sinfo=R.Tensor((1, 256, 56, 56), dtype="float32"))
            lv31 = R.call_tir(cls.batch_norm3, (lv8, metadata["relax.expr.Constant"][25], metadata["relax.expr.Constant"][26], metadata["relax.expr.Constant"][27], metadata["relax.expr.Constant"][28]), out_sinfo=[R.Tensor((1, 256, 56, 56), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")])
            lv9: R.Tensor((1, 256, 56, 56), dtype="float32") = lv31[0]
            lv10_1 = R.call_tir(cls.fused_relu2, (lv9,), out_sinfo=R.Tensor((1, 256, 56, 56), dtype="float32"))
            lv36 = R.call_tir(cls.conv2d4, (lv10_1, metadata["relax.expr.Constant"][29]), out_sinfo=R.Tensor((1, 64, 56, 56), dtype="float32"))
            ...
            lv11_1: R.Tensor((1, 64, 56, 56), dtype="float32") = lv37[0]
            lv12 = R.call_tir(cls.fused_relu1, (lv11_1,), out_sinfo=R.Tensor((1, 64, 56, 56), dtype="float32"))
            lv42 = R.call_tir(cls.conv2d2, (lv12, metadata["relax.expr.Constant"][34]), out_sinfo=R.Tensor((1, 64, 56, 56), dtype="float32"))
            ...
            lv13: R.Tensor((1, 64, 56, 56), dtype="float32") = lv43[0]
            lv14 = R.call_tir(cls.fused_relu1, (lv13,), out_sinfo=R.Tensor((1, 64, 56, 56), dtype="float32"))
            lv15 = R.call_tir(cls.fused_conv2d3_add, (lv14, metadata["relax.expr.Constant"][39], lv8), out_sinfo=R.Tensor((1, 256, 56, 56), dtype="float32"))
            lv50 = R.call_tir(cls.batch_norm3, (lv15, metadata["relax.expr.Constant"][40], metadata["relax.expr.Constant"][41], metadata["relax.expr.Constant"][42], metadata["relax.expr.Constant"][43]), out_sinfo=[R.Tensor((1, 256, 56, 56), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")])
            lv16_1: R.Tensor((1, 256, 56, 56), dtype="float32") = lv50[0]
            lv17_1 = R.call_tir(cls.fused_relu2, (lv16_1,), out_sinfo=R.Tensor((1, 256, 56, 56), dtype="float32"))
            lv55 = R.call_tir(cls.conv2d4, (lv17_1, metadata["relax.expr.Constant"][44]), out_sinfo=R.Tensor((1, 64, 56, 56), dtype="float32"))
            ...
            lv18: R.Tensor((1, 64, 56, 56), dtype="float32") = lv56[0]
            lv19 = R.call_tir(cls.fused_relu1, (lv18,), out_sinfo=R.Tensor((1, 64, 56, 56), dtype="float32"))
            lv61 = R.call_tir(cls.conv2d2, (lv19, metadata["relax.expr.Constant"][49]), out_sinfo=R.Tensor((1, 64, 56, 56), dtype="float32"))
            ...
            lv20: R.Tensor((1, 64, 56, 56), dtype="float32") = lv62[0]
            lv21 = R.call_tir(cls.fused_relu1, (lv20,), out_sinfo=R.Tensor((1, 64, 56, 56), dtype="float32"))
            lv22_1 = R.call_tir(cls.fused_conv2d3_add, (lv21, metadata["relax.expr.Constant"][54], lv15), out_sinfo=R.Tensor((1, 256, 56, 56), dtype="float32"))
            lv69 = R.call_tir(cls.batch_norm3, (lv22_1, metadata["relax.expr.Constant"][55], metadata["relax.expr.Constant"][56], metadata["relax.expr.Constant"][57], metadata["relax.expr.Constant"][58]), out_sinfo=[R.Tensor((1, 256, 56, 56), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")])
            lv23_1: R.Tensor((1, 256, 56, 56), dtype="float32") = lv69[0]
            lv24 = R.call_tir(cls.fused_relu2, (lv23_1,), out_sinfo=R.Tensor((1, 256, 56, 56), dtype="float32"))
            lv74 = R.call_tir(cls.conv2d5, (lv24, metadata["relax.expr.Constant"][59]), out_sinfo=R.Tensor((1, 128, 56, 56), dtype="float32"))
            ...
            lv25: R.Tensor((1, 128, 56, 56), dtype="float32") = lv75[0]
            lv26 = R.call_tir(cls.fused_relu3, (lv25,), out_sinfo=R.Tensor((1, 128, 56, 56), dtype="float32"))
            lv80 = R.call_tir(cls.conv2d6, (lv26, metadata["relax.expr.Constant"][64]), out_sinfo=R.Tensor((1, 128, 28, 28), dtype="float32"))
            ...
            lv27: R.Tensor((1, 128, 28, 28), dtype="float32") = lv81[0]
            lv28 = R.call_tir(cls.fused_relu4, (lv27,), out_sinfo=R.Tensor((1, 128, 28, 28), dtype="float32"))
            lv87 = R.call_tir(cls.conv2d8, (lv24, metadata["relax.expr.Constant"][69]), out_sinfo=R.Tensor((1, 512, 28, 28), dtype="float32"))
            lv29_1 = R.call_tir(cls.fused_conv2d7_add1, (lv28, metadata["relax.expr.Constant"][70], lv87), out_sinfo=R.Tensor((1, 512, 28, 28), dtype="float32"))
            lv89 = R.call_tir(cls.batch_norm6, (lv29_1, metadata["relax.expr.Constant"][71], metadata["relax.expr.Constant"][72], metadata["relax.expr.Constant"][73], metadata["relax.expr.Constant"][74]), out_sinfo=[R.Tensor((1, 512, 28, 28), dtype="float32"), R.Tensor((512,), dtype="float32"), R.Tensor((512,), dtype="float32")])
            lv30: R.Tensor((1, 512, 28, 28), dtype="float32") = lv89[0]
            lv31_1 = R.call_tir(cls.fused_relu5, (lv30,), out_sinfo=R.Tensor((1, 512, 28, 28), dtype="float32"))
            lv94 = R.call_tir(cls.conv2d9, (lv31_1, metadata["relax.expr.Constant"][75]), out_sinfo=R.Tensor((1, 128, 28, 28), dtype="float32"))
            ...
            lv32: R.Tensor((1, 128, 28, 28), dtype="float32") = lv95[0]
            lv33 = R.call_tir(cls.fused_relu4, (lv32,), out_sinfo=R.Tensor((1, 128, 28, 28), dtype="float32"))
            lv100 = R.call_tir(cls.conv2d10, (lv33, metadata["relax.expr.Constant"][80]), out_sinfo=R.Tensor((1, 128, 28, 28), dtype="float32"))
            ...
            lv34: R.Tensor((1, 128, 28, 28), dtype="float32") = lv101[0]
            lv35 = R.call_tir(cls.fused_relu4, (lv34,), out_sinfo=R.Tensor((1, 128, 28, 28), dtype="float32"))
            lv36_1 = R.call_tir(cls.fused_conv2d7_add1, (lv35, metadata["relax.expr.Constant"][85], lv29_1), out_sinfo=R.Tensor((1, 512, 28, 28), dtype="float32"))
            lv108 = R.call_tir(cls.batch_norm6, (lv36_1, metadata["relax.expr.Constant"][86], metadata["relax.expr.Constant"][87], metadata["relax.expr.Constant"][88], metadata["relax.expr.Constant"][89]), out_sinfo=[R.Tensor((1, 512, 28, 28), dtype="float32"), R.Tensor((512,), dtype="float32"), R.Tensor((512,), dtype="float32")])
            lv37_1: R.Tensor((1, 512, 28, 28), dtype="float32") = lv108[0]
            lv38 = R.call_tir(cls.fused_relu5, (lv37_1,), out_sinfo=R.Tensor((1, 512, 28, 28), dtype="float32"))
            lv113 = R.call_tir(cls.conv2d9, (lv38, metadata["relax.expr.Constant"][90]), out_sinfo=R.Tensor((1, 128, 28, 28), dtype="float32"))
            ...
            lv39: R.Tensor((1, 128, 28, 28), dtype="float32") = lv114[0]
            lv40 = R.call_tir(cls.fused_relu4, (lv39,), out_sinfo=R.Tensor((1, 128, 28, 28), dtype="float32"))
            lv119 = R.call_tir(cls.conv2d10, (lv40, metadata["relax.expr.Constant"][95]), out_sinfo=R.Tensor((1, 128, 28, 28), dtype="float32"))
            ...
            lv41: R.Tensor((1, 128, 28, 28), dtype="float32") = lv120[0]
            lv42_1 = R.call_tir(cls.fused_relu4, (lv41,), out_sinfo=R.Tensor((1, 128, 28, 28), dtype="float32"))
            lv43_1 = R.call_tir(cls.fused_conv2d7_add1, (lv42_1, metadata["relax.expr.Constant"][100], lv36_1), out_sinfo=R.Tensor((1, 512, 28, 28), dtype="float32"))
            lv127 = R.call_tir(cls.batch_norm6, (lv43_1, metadata["relax.expr.Constant"][101], metadata["relax.expr.Constant"][102], metadata["relax.expr.Constant"][103], metadata["relax.expr.Constant"][104]), out_sinfo=[R.Tensor((1, 512, 28, 28), dtype="float32"), R.Tensor((512,), dtype="float32"), R.Tensor((512,), dtype="float32")])
            lv44: R.Tensor((1, 512, 28, 28), dtype="float32") = lv127[0]
            lv45 = R.call_tir(cls.fused_relu5, (lv44,), out_sinfo=R.Tensor((1, 512, 28, 28), dtype="float32"))
            lv132 = R.call_tir(cls.conv2d9, (lv45, metadata["relax.expr.Constant"][105]), out_sinfo=R.Tensor((1, 128, 28, 28), dtype="float32"))
            ...
            lv46: R.Tensor((1, 128, 28, 28), dtype="float32") = lv133[0]
            lv47 = R.call_tir(cls.fused_relu4, (lv46,), out_sinfo=R.Tensor((1, 128, 28, 28), dtype="float32"))
            lv138 = R.call_tir(cls.conv2d10, (lv47, metadata["relax.expr.Constant"][110]), out_sinfo=R.Tensor((1, 128, 28, 28), dtype="float32"))
            ...
            lv48: R.Tensor((1, 128, 28, 28), dtype="float32") = lv139[0]
            lv49 = R.call_tir(cls.fused_relu4, (lv48,), out_sinfo=R.Tensor((1, 128, 28, 28), dtype="float32"))
            lv50_1 = R.call_tir(cls.fused_conv2d7_add1, (lv49, metadata["relax.expr.Constant"][115], lv43_1), out_sinfo=R.Tensor((1, 512, 28, 28), dtype="float32"))
            lv146 = R.call_tir(cls.batch_norm6, (lv50_1, metadata["relax.expr.Constant"][116], metadata["relax.expr.Constant"][117], metadata["relax.expr.Constant"][118], metadata["relax.expr.Constant"][119]), out_sinfo=[R.Tensor((1, 512, 28, 28), dtype="float32"), R.Tensor((512,), dtype="float32"), R.Tensor((512,), dtype="float32")])
            lv51: R.Tensor((1, 512, 28, 28), dtype="float32") = lv146[0]
            lv52 = R.call_tir(cls.fused_relu5, (lv51,), out_sinfo=R.Tensor((1, 512, 28, 28), dtype="float32"))
            lv151 = R.call_tir(cls.conv2d11, (lv52, metadata["relax.expr.Constant"][120]), out_sinfo=R.Tensor((1, 256, 28, 28), dtype="float32"))
            ...
            lv53: R.Tensor((1, 256, 28, 28), dtype="float32") = lv152[0]
            lv54 = R.call_tir(cls.fused_relu6, (lv53,), out_sinfo=R.Tensor((1, 256, 28, 28), dtype="float32"))
            lv157 = R.call_tir(cls.conv2d12, (lv54, metadata["relax.expr.Constant"][125]), out_sinfo=R.Tensor((1, 256, 14, 14), dtype="float32"))
            ...
            lv55_1: R.Tensor((1, 256, 14, 14), dtype="float32") = lv158[0]
            lv56_1 = R.call_tir(cls.fused_relu7, (lv55_1,), out_sinfo=R.Tensor((1, 256, 14, 14), dtype="float32"))
            lv164 = R.call_tir(cls.conv2d14, (lv52, metadata["relax.expr.Constant"][130]), out_sinfo=R.Tensor((1, 1024, 14, 14), dtype="float32"))
            lv57 = R.call_tir(cls.fused_conv2d13_add2, (lv56_1, metadata["relax.expr.Constant"][131], lv164), out_sinfo=R.Tensor((1, 1024, 14, 14), dtype="float32"))
            lv166 = R.call_tir(cls.batch_norm9, (lv57, metadata["relax.expr.Constant"][132], metadata["relax.expr.Constant"][133], metadata["relax.expr.Constant"][134], metadata["relax.expr.Constant"][135]), out_sinfo=[R.Tensor((1, 1024, 14, 14), dtype="float32"), R.Tensor((1024,), dtype="float32"), R.Tensor((1024,), dtype="float32")])
            lv58: R.Tensor((1, 1024, 14, 14), dtype="float32") = lv166[0]
            lv59 = R.call_tir(cls.fused_relu8, (lv58,), out_sinfo=R.Tensor((1, 1024, 14, 14), dtype="float32"))
            lv171 = R.call_tir(cls.conv2d15, (lv59, metadata["relax.expr.Constant"][136]), out_sinfo=R.Tensor((1, 256, 14, 14), dtype="float32"))
            ...
            lv60: R.Tensor((1, 256, 14, 14), dtype="float32") = lv172[0]
            lv61_1 = R.call_tir(cls.fused_relu7, (lv60,), out_sinfo=R.Tensor((1, 256, 14, 14), dtype="float32"))
            lv177 = R.call_tir(cls.conv2d16, (lv61_1, metadata["relax.expr.Constant"][141]), out_sinfo=R.Tensor((1, 256, 14, 14), dtype="float32"))
            ...
            lv62_1: R.Tensor((1, 256, 14, 14), dtype="float32") = lv178[0]
            lv63 = R.call_tir(cls.fused_relu7, (lv62_1,), out_sinfo=R.Tensor((1, 256, 14, 14), dtype="float32"))
            lv64 = R.call_tir(cls.fused_conv2d13_add2, (lv63, metadata["relax.expr.Constant"][146], lv57), out_sinfo=R.Tensor((1, 1024, 14, 14), dtype="float32"))
            lv185 = R.call_tir(cls.batch_norm9, (lv64, metadata["relax.expr.Constant"][147], metadata["relax.expr.Constant"][148], metadata["relax.expr.Constant"][149], metadata["relax.expr.Constant"][150]), out_sinfo=[R.Tensor((1, 1024, 14, 14), dtype="float32"), R.Tensor((1024,), dtype="float32"), R.Tensor((1024,), dtype="float32")])
            lv65: R.Tensor((1, 1024, 14, 14), dtype="float32") = lv185[0]
            lv66 = R.call_tir(cls.fused_relu8, (lv65,), out_sinfo=R.Tensor((1, 1024, 14, 14), dtype="float32"))
            lv190 = R.call_tir(cls.conv2d15, (lv66, metadata["relax.expr.Constant"][151]), out_sinfo=R.Tensor((1, 256, 14, 14), dtype="float32"))
            ...
            lv67: R.Tensor((1, 256, 14, 14), dtype="float32") = lv191[0]
            lv68 = R.call_tir(cls.fused_relu7, (lv67,), out_sinfo=R.Tensor((1, 256, 14, 14), dtype="float32"))
            lv196 = R.call_tir(cls.conv2d16, (lv68, metadata["relax.expr.Constant"][156]), out_sinfo=R.Tensor((1, 256, 14, 14), dtype="float32"))
            ...
            lv69_1: R.Tensor((1, 256, 14, 14), dtype="float32") = lv197[0]
            lv70 = R.call_tir(cls.fused_relu7, (lv69_1,), out_sinfo=R.Tensor((1, 256, 14, 14), dtype="float32"))
            lv71 = R.call_tir(cls.fused_conv2d13_add2, (lv70, metadata["relax.expr.Constant"][161], lv64), out_sinfo=R.Tensor((1, 1024, 14, 14), dtype="float32"))
            lv204 = R.call_tir(cls.batch_norm9, (lv71, metadata["relax.expr.Constant"][162], metadata["relax.expr.Constant"][163], metadata["relax.expr.Constant"][164], metadata["relax.expr.Constant"][165]), out_sinfo=[R.Tensor((1, 1024, 14, 14), dtype="float32"), R.Tensor((1024,), dtype="float32"), R.Tensor((1024,), dtype="float32")])
            lv72: R.Tensor((1, 1024, 14, 14), dtype="float32") = lv204[0]
            lv73 = R.call_tir(cls.fused_relu8, (lv72,), out_sinfo=R.Tensor((1, 1024, 14, 14), dtype="float32"))
            lv209 = R.call_tir(cls.conv2d15, (lv73, metadata["relax.expr.Constant"][166]), out_sinfo=R.Tensor((1, 256, 14, 14), dtype="float32"))
            ...
            lv74_1: R.Tensor((1, 256, 14, 14), dtype="float32") = lv210[0]
            lv75_1 = R.call_tir(cls.fused_relu7, (lv74_1,), out_sinfo=R.Tensor((1, 256, 14, 14), dtype="float32"))
            lv215 = R.call_tir(cls.conv2d16, (lv75_1, metadata["relax.expr.Constant"][171]), out_sinfo=R.Tensor((1, 256, 14, 14), dtype="float32"))
            ...
            lv76: R.Tensor((1, 256, 14, 14), dtype="float32") = lv216[0]
            lv77 = R.call_tir(cls.fused_relu7, (lv76,), out_sinfo=R.Tensor((1, 256, 14, 14), dtype="float32"))
            lv78 = R.call_tir(cls.fused_conv2d13_add2, (lv77, metadata["relax.expr.Constant"][176], lv71), out_sinfo=R.Tensor((1, 1024, 14, 14), dtype="float32"))
            lv223 = R.call_tir(cls.batch_norm9, (lv78, metadata["relax.expr.Constant"][177], metadata["relax.expr.Constant"][178], metadata["relax.expr.Constant"][179], metadata["relax.expr.Constant"][180]), out_sinfo=[R.Tensor((1, 1024, 14, 14), dtype="float32"), R.Tensor((1024,), dtype="float32"), R.Tensor((1024,), dtype="float32")])
            lv79: R.Tensor((1, 1024, 14, 14), dtype="float32") = lv223[0]
            lv80_1 = R.call_tir(cls.fused_relu8, (lv79,), out_sinfo=R.Tensor((1, 1024, 14, 14), dtype="float32"))
            lv228 = R.call_tir(cls.conv2d15, (lv80_1, metadata["relax.expr.Constant"][181]), out_sinfo=R.Tensor((1, 256, 14, 14), dtype="float32"))
            ...
            lv81_1: R.Tensor((1, 256, 14, 14), dtype="float32") = lv229[0]
            lv82 = R.call_tir(cls.fused_relu7, (lv81_1,), out_sinfo=R.Tensor((1, 256, 14, 14), dtype="float32"))
            lv234 = R.call_tir(cls.conv2d16, (lv82, metadata["relax.expr.Constant"][186]), out_sinfo=R.Tensor((1, 256, 14, 14), dtype="float32"))
            ...
            lv83: R.Tensor((1, 256, 14, 14), dtype="float32") = lv235[0]
            lv84 = R.call_tir(cls.fused_relu7, (lv83,), out_sinfo=R.Tensor((1, 256, 14, 14), dtype="float32"))
            lv85 = R.call_tir(cls.fused_conv2d13_add2, (lv84, metadata["relax.expr.Constant"][191], lv78), out_sinfo=R.Tensor((1, 1024, 14, 14), dtype="float32"))
            lv242 = R.call_tir(cls.batch_norm9, (lv85, metadata["relax.expr.Constant"][192], metadata["relax.expr.Constant"][193], metadata["relax.expr.Constant"][194], metadata["relax.expr.Constant"][195]), out_sinfo=[R.Tensor((1, 1024, 14, 14), dtype="float32"), R.Tensor((1024,), dtype="float32"), R.Tensor((1024,), dtype="float32")])
            lv86: R.Tensor((1, 1024, 14, 14), dtype="float32") = lv242[0]
            lv87_1 = R.call_tir(cls.fused_relu8, (lv86,), out_sinfo=R.Tensor((1, 1024, 14, 14), dtype="float32"))
            lv247 = R.call_tir(cls.conv2d15, (lv87_1, metadata["relax.expr.Constant"][196]), out_sinfo=R.Tensor((1, 256, 14, 14), dtype="float32"))
            ...
            lv88: R.Tensor((1, 256, 14, 14), dtype="float32") = lv248[0]
            lv89_1 = R.call_tir(cls.fused_relu7, (lv88,), out_sinfo=R.Tensor((1, 256, 14, 14), dtype="float32"))
            lv253 = R.call_tir(cls.conv2d16, (lv89_1, metadata["relax.expr.Constant"][201]), out_sinfo=R.Tensor((1, 256, 14, 14), dtype="float32"))
            ...
            lv90: R.Tensor((1, 256, 14, 14), dtype="float32") = lv254[0]
            lv91 = R.call_tir(cls.fused_relu7, (lv90,), out_sinfo=R.Tensor((1, 256, 14, 14), dtype="float32"))
            lv92 = R.call_tir(cls.fused_conv2d13_add2, (lv91, metadata["relax.expr.Constant"][206], lv85), out_sinfo=R.Tensor((1, 1024, 14, 14), dtype="float32"))
            lv261 = R.call_tir(cls.batch_norm9, (lv92, metadata["relax.expr.Constant"][207], metadata["relax.expr.Constant"][208], metadata["relax.expr.Constant"][209], metadata["relax.expr.Constant"][210]), out_sinfo=[R.Tensor((1, 1024, 14, 14), dtype="float32"), R.Tensor((1024,), dtype="float32"), R.Tensor((1024,), dtype="float32")])
            lv93: R.Tensor((1, 1024, 14, 14), dtype="float32") = lv261[0]
            lv94_1 = R.call_tir(cls.fused_relu8, (lv93,), out_sinfo=R.Tensor((1, 1024, 14, 14), dtype="float32"))
            lv266 = R.call_tir(cls.conv2d17, (lv94_1, metadata["relax.expr.Constant"][211]), out_sinfo=R.Tensor((1, 512, 14, 14), dtype="float32"))
            ...
            lv95_1: R.Tensor((1, 512, 14, 14), dtype="float32") = lv267[0]
            lv96 = R.call_tir(cls.fused_relu9, (lv95_1,), out_sinfo=R.Tensor((1, 512, 14, 14), dtype="float32"))
            lv272 = R.call_tir(cls.conv2d18, (lv96, metadata["relax.expr.Constant"][216]), out_sinfo=R.Tensor((1, 512, 7, 7), dtype="float32"))
            ...
            lv97: R.Tensor((1, 512, 7, 7), dtype="float32") = lv273[0]
            lv98 = R.call_tir(cls.fused_relu10, (lv97,), out_sinfo=R.Tensor((1, 512, 7, 7), dtype="float32"))
            lv279 = R.call_tir(cls.conv2d20, (lv94_1, metadata["relax.expr.Constant"][221]), out_sinfo=R.Tensor((1, 2048, 7, 7), dtype="float32"))
            lv99 = R.call_tir(cls.fused_conv2d19_add3, (lv98, metadata["relax.expr.Constant"][222], lv279), out_sinfo=R.Tensor((1, 2048, 7, 7), dtype="float32"))
            lv281 = R.call_tir(cls.batch_norm12, (lv99, metadata["relax.expr.Constant"][223], metadata["relax.expr.Constant"][224], metadata["relax.expr.Constant"][225], metadata["relax.expr.Constant"][226]), out_sinfo=[R.Tensor((1, 2048, 7, 7), dtype="float32"), R.Tensor((2048,), dtype="float32"), R.Tensor((2048,), dtype="float32")])
            lv100_1: R.Tensor((1, 2048, 7, 7), dtype="float32") = lv281[0]
            lv101_1 = R.call_tir(cls.fused_relu11, (lv100_1,), out_sinfo=R.Tensor((1, 2048, 7, 7), dtype="float32"))
            lv286 = R.call_tir(cls.conv2d21, (lv101_1, metadata["relax.expr.Constant"][227]), out_sinfo=R.Tensor((1, 512, 7, 7), dtype="float32"))
            ...
            lv102: R.Tensor((1, 512, 7, 7), dtype="float32") = lv287[0]
            lv103 = R.call_tir(cls.fused_relu10, (lv102,), out_sinfo=R.Tensor((1, 512, 7, 7), dtype="float32"))
            lv292 = R.call_tir(cls.conv2d22, (lv103, metadata["relax.expr.Constant"][232]), out_sinfo=R.Tensor((1, 512, 7, 7), dtype="float32"))
            ...
            lv104: R.Tensor((1, 512, 7, 7), dtype="float32") = lv293[0]
            lv105 = R.call_tir(cls.fused_relu10, (lv104,), out_sinfo=R.Tensor((1, 512, 7, 7), dtype="float32"))
            lv106 = R.call_tir(cls.fused_conv2d19_add3, (lv105, metadata["relax.expr.Constant"][237], lv99), out_sinfo=R.Tensor((1, 2048, 7, 7), dtype="float32"))
            lv300 = R.call_tir(cls.batch_norm12, (lv106, metadata["relax.expr.Constant"][238], metadata["relax.expr.Constant"][239], metadata["relax.expr.Constant"][240], metadata["relax.expr.Constant"][241]), out_sinfo=[R.Tensor((1, 2048, 7, 7), dtype="float32"), R.Tensor((2048,), dtype="float32"), R.Tensor((2048,), dtype="float32")])
            lv107: R.Tensor((1, 2048, 7, 7), dtype="float32") = lv300[0]
            lv108_1 = R.call_tir(cls.fused_relu11, (lv107,), out_sinfo=R.Tensor((1, 2048, 7, 7), dtype="float32"))
            lv305 = R.call_tir(cls.conv2d21, (lv108_1, metadata["relax.expr.Constant"][242]), out_sinfo=R.Tensor((1, 512, 7, 7), dtype="float32"))
            ...
            lv109: R.Tensor((1, 512, 7, 7), dtype="float32") = lv306[0]
            lv110 = R.call_tir(cls.fused_relu10, (lv109,), out_sinfo=R.Tensor((1, 512, 7, 7), dtype="float32"))
            lv311 = R.call_tir(cls.conv2d22, (lv110, metadata["relax.expr.Constant"][247]), out_sinfo=R.Tensor((1, 512, 7, 7), dtype="float32"))
            ...
            lv111: R.Tensor((1, 512, 7, 7), dtype="float32") = lv312[0]
            lv112 = R.call_tir(cls.fused_relu10, (lv111,), out_sinfo=R.Tensor((1, 512, 7, 7), dtype="float32"))
            lv113_1 = R.call_tir(cls.fused_conv2d19_add3, (lv112, metadata["relax.expr.Constant"][252], lv106), out_sinfo=R.Tensor((1, 2048, 7, 7), dtype="float32"))
            lv319 = R.call_tir(cls.batch_norm12, (lv113_1, metadata["relax.expr.Constant"][253], metadata["relax.expr.Constant"][254], metadata["relax.expr.Constant"][255], metadata["relax.expr.Constant"][256]), out_sinfo=[R.Tensor((1, 2048, 7, 7), dtype="float32"), R.Tensor((2048,), dtype="float32"), R.Tensor((2048,), dtype="float32")])
            lv114_1: R.Tensor((1, 2048, 7, 7), dtype="float32") = lv319[0]
            lv115 = R.call_tir(cls.fused_relu11, (lv114_1,), out_sinfo=R.Tensor((1, 2048, 7, 7), dtype="float32"))
            lv324 = R.call_tir(cls.mean, (lv115,), out_sinfo=R.Tensor((1, 2048, 1, 1), dtype="float32"))
            lv325 = R.call_tir(cls.reshape, (lv324,), out_sinfo=R.Tensor((1, 2048), dtype="float32"))
            gv = R.call_tir(cls.fused_matmul_add4, (lv325, metadata["relax.expr.Constant"][257], metadata["relax.expr.Constant"][258]), out_sinfo=R.Tensor((1, 1000), dtype="float32"))
            R.output(gv)
        return gv
